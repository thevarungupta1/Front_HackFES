...
describe('DashboardService', () => {
  ...
  it(`should return only enrolled associates`, async(inject([HttpClient, HttpTestingController],
    (http: HttpClient, backend: HttpTestingController) => {
      http.get('/api/Enrollment/GetEnrolledAssociates').subscribe((next) => {
        expect(next).toEqual({
          id: 1234567,
          name: "senthil",
          designation: "associate",
      ...
      backend.match({
        url: '/api/Enrollment/GetEnrolledAssociates',
        method: 'GET'
      })[0].flush({
        id: 1234567,
        name: "senthil",
  ...
  it(`should expect a GET /api/Enrollment/GetEnrolledAssociates`, async(inject([HttpClient, HttpTestingController],
    (http: HttpClient, backend: HttpTestingController) => {
      http.get('/api/Enrollment/GetEnrolledAssociates').subscribe();
  ...
  it(`should return all new volunteers`, async(inject([HttpClient, HttpTestingController],
    (http: HttpClient, backend: HttpTestingController) => {
      http.get('/api/Enrollment/GetAllNewVolunteers').subscribe((next) => {
        expect(next).toEqual({
          id: 1234567,
          name: "senthil",
          designation: "associate",
      ...
      backend.match({
        url: '/api/Enrollment/GetAllNewVolunteers',
        method: 'GET'
      })[0].flush({
        id: 1234567,
        name: "senthil",
  ...
  it(`should expect a GET /api/Enrollment/GetAllNewVolunteers`, async(inject([HttpClient, HttpTestingController],
    (http: HttpClient, backend: HttpTestingController) => {
      http.get('/api/Enrollment/GetAllNewVolunteers').subscribe();
